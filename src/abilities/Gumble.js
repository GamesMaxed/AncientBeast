  ...
  G.abilities[14] = [
    ...
    //   Second Ability: Gummy Mallet
    {
      ...
      query() {
        ...
        choices.sort((choice1, choice2) => choice1.length < choice2.length);
        G.grid.queryChoice({
          fnOnCancel() {
    ...
    //   Thirt Ability: Royal Seal
    {
      ...
      query() {
        ...
        const hexes = creature.hexagons.concat(G.grid.getFlyingRange(creature.x, creature.y, range, creature.size, creature.id));
